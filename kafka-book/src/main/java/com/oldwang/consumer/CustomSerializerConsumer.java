...
import com.oldwang.custom_serializer.CustomUserDeserializer;
...
public class CustomSerializerConsumer {
    ...
    public static void main(String[] args) {
        ...
        properties.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG,ConsumerProtostuffSerializser.class.getName());
